...
public class Quadrilateral implements Shape2D{
    ...
    public Point2D.Double getS1(){
        return new Point2D.Double(s1.x, s1.y);
    }
    public Point2D.Double getS2(){
        return new Point2D.Double(s2.x, s2.y);
    }
    public Point2D.Double getS3(){
        return new Point2D.Double(s3.x, s3.y);
    }
    public Point2D.Double getS4(){
        return new Point2D.Double(s4.x, s4.y);
    }
